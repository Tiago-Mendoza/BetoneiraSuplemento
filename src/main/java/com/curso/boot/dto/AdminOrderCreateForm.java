...
public class AdminOrderCreateForm {

    @NotBlank(message = "Informe o e-mail do cliente.")
    @Email(message = "Informe um e-mail vÃ¡lido.")
    private String customerEmail;

    @NotBlank(message = "Informe o nome do destinatÃ¡rio.")
    @Size(min = 3, max = 100, message = "Informe um nome vÃ¡lido.")
    ...
    @NotBlank(message = "Selecione um produto.")
